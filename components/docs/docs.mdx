...
To deploy Next.js with <PlatformLink /> see [our guide for Deploying Next.js](https://zeit.co/guides/deploying-nextjs-with-now/) or the [Next.js Learn section about deploying](https://nextjs.org/learn/basics/deploying-a-nextjs-app/deploying-to-zeit-now).
...
<details>
  ...
  <ul>
    <li>
      <a href="https://github.com/zeit/now-examples/tree/master/nextjs">now.sh</a>
    </li>
    <li>
...
Using the serverless target, you can deploy Next.js to <PlatformLink /> with all of the benefits and added ease of control like for example; [custom routes](https://zeit.co/guides/custom-next-js-server-to-routes/) and caching headers. See [our guide for Deploying Next.js](https://zeit.co/guides/deploying-nextjs-with-now/) for more information.
...
<details>
  ...
  <ul>
    <li>
      <a href="https://github.com/zeit/next.js/tree/canary/examples/amp">amp</a>
    </li>
  </ul>
</details>
