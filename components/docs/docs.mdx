...
import OrgLink from '../../components/name/org-link';
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/basic-css">Basic css</a>
    </li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-styled-components">Styled components</a>
    </li>
    <li>
      <a href="/examples/with-styletron">Styletron</a>
    </li>
    <li>
      <a href="/examples/with-glamor">Glamor</a>
    </li>
    <li>
      <a href="/examples/with-cxs">Cxs</a>
    </li>
    <li>
      <a href="/examples/with-aphrodite">Aphrodite</a>
    </li>
    <li>
      <a href="/examples/with-fela">Fela</a>
    </li>
  </ul>
</details>
...
- [@zeit/next-css](https://github.com/vercel/next-plugins/tree/master/packages/next-css)
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/dynamic-routing">Dynamic routing</a>
    </li>
  </ul>
</details>
...
> **Note**: If deploying to <PlatformLink /> dynamic routes will work out-of-the-box.
> You do not need to configure custom routes in a `now.json` file.
>
> If you are new to <PlatformLink />, you can learn how to deploy a Next.js app to it in the [_Deploying a Next.js App_ Learn section](https://nextjs.org/learn/basics/deploying-a-nextjs-app).
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/head-elements">Head elements</a>
    </li>
    <li>
      <a href="/examples/layout-component">Layout component</a>
    </li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/data-fetch">Data fetch</a>
    </li>
  </ul>
</details>
...
Notice that to load data when the page loads, we use `getInitialProps` which is an [`async`](https://vercel.com/blog/async-and-await) static method. It can asynchronously fetch anything that resolves to a JavaScript plain `Object`, which populates `props`.
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-url-object-routing">With URL Object Routing</a>
    </li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/using-router">Basic routing</a>
    </li>
    <li>
      <a href="/examples/with-loading">With a page loading indicator</a>
    </li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-shallow-routing">Shallow Routing</a>
    </li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/using-with-router">Using the `withRouter` utility</a>
    </li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-prefetching">Prefetching</a>
    </li>
  </ul>
</details>
...
Since Next.js server-renders your pages, this allows all the future interaction paths of your app to be instant. Effectively Next.js gives you the great initial download performance of a _website_, with the ahead-of-time download capabilities of an _app_. [Read more](https://vercel.com/blog/next#anticipation-is-the-key-to-performance).
...
> `<link rel="preload">` is used for prefetching. Sometimes browsers will show a warning if the resource is not used within 3 seconds, these warnings can be ignored as per https://github.com/vercel/next.js/issues/6517#issuecomment-469063892.
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/api-routes">Basic API routes</a>
    </li>
    <li>
      <a href="/examples/api-routes-micro">API routes with micro</a>
    </li>
    <li>
      <a href="/examples/api-routes-middleware">API routes with middleware</a>
    </li>
    <li>
      <a href="/examples/api-routes-graphql">API routes with GraphQL server</a>
    </li>
    <li>
      <a href="/examples/api-routes-rest">API routes with REST</a>
    </li>
  </ul>
</details>
...
As an added bonus, you can also use any [Micro](https://github.com/vercel/micro) compatible [middleware](https://github.com/amio/awesome-micro)!
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/custom-server">Basic custom server</a>
    </li>
    <li>
      <a href="/examples/custom-server-express">Express integration</a>
    </li>
    <li>
      <a href="/examples/custom-server-hapi">Hapi integration</a>
    </li>
    <li>
      <a href="/examples/custom-server-koa">Koa integration</a>
    </li>
    <li>
      <a href="/examples/parameterized-routing">Parameterized routing</a>
    </li>
    <li>
      <a href="/examples/ssr-caching">SSR caching</a>
    </li>
  </ul>
</details>
...
// See https://github.com/vercel/next.js/issues/1245 for discussions on Universal Webpack or universal Babel
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-dynamic-import">With Dynamic Import</a>
    </li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-app-layout">Using `_app.js` for layout</a>
    </li>
    <li>
      <a href="/examples/with-componentdidcatch">Using `_app.js` to override `componentDidCatch`</a>
    </li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-styled-components">Styled components custom document</a>
    </li>
  </ul>
</details>
...
[styled-components](https://github.com/vercel/next.js/tree/canary/examples/with-styled-components) or [emotion](https://github.com/vercel/next.js/tree/canary/examples/with-emotion).
Note, [styled-jsx](https://github.com/vercel/styled-jsx) is included in Next.js by default.
...
`phase` is the current context in which the configuration is loaded. You can see all phases here: [constants](https://github.com/vercel/next.js/tree/canary/packages/next/next-server/lib/constants.ts)
...
This is development-only feature. If you want to cache SSR pages in production, please see [SSR-caching](https://github.com/vercel/next.js/tree/canary/examples/ssr-caching) example.

#### Configuring extensions looked for when resolving pages in `pages`

Aimed at modules like [`@next/mdx`](https://github.com/vercel/next.js/tree/canary/packages/next-mdx), that add support for pages ending with `.mdx`. `pageExtensions` allows you to configure the extensions looked for in the `pages` directory when resolving pages.
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-webpack-bundle-analyzer">Custom webpack bundle analyzer</a>
    </li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-custom-babel-config">Custom babel configuration</a>
    </li>
  </ul>
</details>
...
To deploy Next.js with <PlatformLink /> see [our guide for Deploying Next.js](https://vercel.com/guides/deploying-nextjs-with-now/) or the [Next.js Learn section about deploying](https://nextjs.org/learn/basics/deploying-a-nextjs-app/deploying-to-zeit-now).

Next.js can be deployed to other hosting solutions too. Please have a look at the ['Deployment'](https://github.com/vercel/next.js/wiki/Deployment) section of the wiki.
...
Note: we recommend putting `.next`, or your [custom dist folder](https://github.com/vercel/next.js#custom-configuration), in `.gitignore` or `.npmignore`. Otherwise, use `files` or `now.files` to opt-into a whitelist of files you want to deploy, excluding `.next` or your custom dist folder.
...
<details>
  ...
  <ul>
    <li>
      <a href="https://github.com/vercel/now-examples/tree/master/nextjs">now.sh</a>
    </li>
    <li>
      <a href="https://github.com/TejasQ/anna-artemov.now.sh">anna-artemov.now.sh</a>
    </li>
    <li>We encourage contributing more examples to this section</li>
  </ul>
</details>

Serverless deployment dramatically improves reliability and scalability by splitting your application into smaller parts (also called [**lambdas**](https://vercel.com/docs/v2/deployments/concepts/lambdas/)).
In the case of Next.js, each page in the `pages` directory becomes a serverless lambda.

There are [a number of benefits](https://vercel.com/blog/serverless-express-js-lambdas-with-now-2#benefits-of-serverless-express) to serverless.
...
Using the serverless target, you can deploy Next.js to <PlatformLink /> with all of the benefits and added ease of control like for example; [custom routes](https://vercel.com/guides/custom-next-js-server-to-routes/) and caching headers. See [our guide for Deploying Next.js](https://vercel.com/guides/deploying-nextjs-with-now/) for more information.
...
- Optimized for fast [cold start](https://vercel.com/blog/serverless-ssr#cold-start) of the function
...
The [polyfills](https://github.com/vercel/next.js/tree/canary/examples/with-polyfills) example demonstrates the recommended approach to implement polyfills.
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-static-export">Static export</a>
    </li>
  </ul>
</details>
...
Now you can deploy the `out` directory to any static hosting service. Note that there is an additional step for deploying to GitHub Pages, [documented here](https://github.com/vercel/next.js/wiki/Deploying-a-Next.js-app-into-GitHub-Pages).

For an example, simply visit the `out` directory and run following command to deploy your app to <PlatformLink />.
...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/with-zones">With Zones</a>
    </li>
  </ul>
</details>
...
- Make sure to add an [assetPrefix](https://github.com/vercel/next.js#cdn-support-with-asset-prefix) to avoid conflicts with static files.

### How to merge them

You can merge zones using any HTTP proxy.

You can use [now dev](https://vercel.com/docs/v2/development/basics) as your local development server. It allows you to easily define routing routes for multiple apps like below:
...
For the production deployment, you can use the same configuration and run `now` to do the deployment with <PlatformLink />. Otherwise you can also configure a proxy server to route using a set of routes like the ones above, e.g deploy the docs app to `https://docs.example.com` and the home app to `https://home.example.com` and then add a proxy server for both apps in `https://example.com`.
...
Next.js bundles [styled-jsx](https://github.com/vercel/styled-jsx) supporting scoped css. However you can use any CSS-in-JS solution in your Next app by just including your favorite library [as mentioned before](#css-in-js) in the document.
...
See the documentation about [customizing the babel config](#customizing-babel-config) and [next/preset](https://github.com/vercel/next.js/tree/canary/packages/next/build/babel/preset.ts) for more information.
...
You can check an [example](https://github.com/vercel/next.js/tree/canary/examples/dynamic-routing) to see how it works.
...
Yes! Here's an [example](https://github.com/vercel/next.js/tree/canary/examples/with-redux-thunk).
...
Yes! Here's an [example](https://github.com/vercel/next.js/tree/canary/examples/with-redux).
...
Please see our [contributing.md](https://github.com/vercel/next.js/tree/canary/contributing.md).

## Authors

- Arunoda Susiripala ([@arunoda](https://twitter.com/arunoda)) – <OrgLink />
- Tim Neutkens ([@timneutkens](https://twitter.com/timneutkens)) – <OrgLink />
- Naoyuki Kanezawa ([@nkzawa](https://twitter.com/nkzawa)) – <OrgLink />
- Tony Kovanen ([@tonykovanen](https://twitter.com/tonykovanen)) – <OrgLink />
- Guillermo Rauch ([@rauchg](https://twitter.com/rauchg)) – <OrgLink />
